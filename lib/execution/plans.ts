...
export const PLAN_TEMPLATES: PlanTemplate[] = [
  ...
  {
    intent: "prepare_occ_examination",
    title: "OCC Examination Package",
    patterns: [/occ\s+exam/i, /prepare.*occ/i, /occ\s+examination/i],
    sample: "Prepare our OCC examination package",
    riskLevel: "high",
    modules: ["BankTrust OS", "ComplianceFlow", "Evidence"],
    steps: [
      { title: "Review system risk posture", prompt: "Review system risk posture", kind: "command" },
      { title: "Review high-risk lending decisions", prompt: "Show high-risk decisions", kind: "command", moduleHint: "BankTrust OS" },
      { title: "Verify vendor attestations", prompt: "Show vendors with expiring certifications", kind: "command", moduleHint: "Vendors" },
      { title: "Review BankTrust OS findings", prompt: "Show highest risk module", kind: "command", moduleHint: "BankTrust OS" },
      { title: "Gather regulatory evidence", prompt: "Generate evidence pack for denied decisions", kind: "command", moduleHint: "Evidence" },
      REPORT,
    ],
  },
  {
    intent: "generate_ffiec_readiness",
    title: "FFIEC Readiness Report",
    patterns: [/ffiec/i],
    sample: "Generate an FFIEC readiness report",
    riskLevel: "medium",
    modules: ["BankTrust OS", "ComplianceFlow"],
    steps: [
      { title: "System risk posture", prompt: "Review system risk posture", kind: "command" },
      { title: "BankTrust OS health", prompt: "Show module status for BankTrust OS", kind: "command", moduleHint: "BankTrust OS" },
      { title: "Vendor / third-party risk", prompt: "Show vendors with expiring certifications", kind: "command" },
      REPORT,
    ],
  },
  {
    intent: "generate_fair_lending_evidence",
    title: "Fair Lending Evidence",
    patterns: [/fair\s+lending/i],
    sample: "Generate Fair Lending evidence",
    riskLevel: "high",
    modules: ["BankTrust OS", "Decisions", "Evidence"],
    steps: [
      { title: "Review high-risk lending decisions", prompt: "Show high-risk decisions", kind: "command", moduleHint: "BankTrust OS" },
      { title: "Seal denied-decision evidence", prompt: "Generate evidence pack for denied decisions", kind: "command", moduleHint: "Evidence" },
      REPORT,
    ],
  },
  {
    intent: "review_bsa_aml_posture",
    title: "BSA/AML Posture Review",
    patterns: [/\bbsa\b/i, /\baml\b/i, /anti-?money/i],
    sample: "Prepare BSA/AML audit evidence",
    riskLevel: "high",
    modules: ["BankTrust OS"],
    steps: [
      { title: "BankTrust OS risk review", prompt: "Show highest risk module", kind: "command", moduleHint: "BankTrust OS" },
      { title: "System risk posture", prompt: "Review system risk posture", kind: "command" },
      { title: "Gather audit evidence", prompt: "Generate evidence pack for denied decisions", kind: "command", moduleHint: "Evidence" },
      REPORT,
    ],
  },
  {
